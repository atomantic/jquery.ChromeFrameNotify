 ...
 */
 (function(window,document,undefined){
    ...
    gcfnotify.prototype.init = function() {
		...
		$('head').append('<style type="text/css">#gcfbar{width:100%;padding:5px 0px;border-bottom:1px solid #666;position:absolute;top:0;left:0;z-index:10000;text-align:center;font-family:Bitstream Vera Sans,verdana,sans-serif !important;font-size:11px !important;color:#000 !important;background:#FFFFE1;cursor:default}#gcfupdate{float:left}#gcfclose{position:absolute;top:3px;right:3px;float:right;cursor:pointer}</style>');
    };
    /**
