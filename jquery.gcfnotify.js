/*global CFInstall,$,gcf,gcfnConfig*/
/*jslint browser:true */
 ...
 */
 (function(window,document,undefined){
    ...
    function setCookie(n, v, days) {
        ...
        document.cookie = n + "=" + encodeURI(v) + ((days === null) ? "" : ";expires=" + d.toGMTString());
    }
    /*
    ...
    // run on load
    $(function(){
        window.gcf = new gcfnotify(
            typeof(gcfnConfig) !== 'undefined' ? gcfnConfig : null
        );
    });
})(this,this.document);
